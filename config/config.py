...
OWNER_ID = list(map(int, getenv("OWNER_ID", "1269717144").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/kdrama_time")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://kdrama_times_chat")
